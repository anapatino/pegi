...
import { getStatisticsProposalByProfessor } from "../../controllers/proposal";
import { getStatisticsProjectByProfessor } from "../../controllers/project";
...
export const DashboardProfessor = () => {
  ...
  const proposal = useQuery(
    ["statistics", user],
    () => getStatisticsProposalByProfessor(user.personDocument, requestOptions),
    { enabled: !!user, refetchOnWindowFocus: false, retry: false }
  );

  const project = useQuery(
    ["statisticsproject", user],
    () => getStatisticsProjectByProfessor(user.personDocument, requestOptions),
    { enabled: !!user, refetchOnWindowFocus: false, retry: false }
  );
